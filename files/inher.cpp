...
class details:public linklist
{
	...
	private:
		...
		int id;
	public:
		details(const char *m_name,const char *m_address,
			int m_id);
		details();
		void print();
		void read();
...
class permanent:virtual public details
{
	...
	int grade;
	public:
		permanent(const char *m_name,const char *m_address,
...
{
	public:
		sales(const char *m_name,const char *m_address,int m_id,
