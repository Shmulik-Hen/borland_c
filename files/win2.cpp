	...
	while ((c = getch()) != 27) {
		if (c == 0) {
			...
			case 1:
				switch (dir) {
				case DOWN:
					a.chg_attr(10, 7, 6, WHITE, BLUE);
					break;
				case UP:
					a.chg_attr(21, 4, 7, WHITE, BLUE);
					break;
				}
				a.chg_attr(21, 2, 7, BLACK, LGREY);
				break;
			case 2:
				switch (dir) {
				case DOWN:
					a.chg_attr(21, 2, 7, WHITE, BLUE);
					break;
				case UP:
					a.chg_attr(24, 7, 6, WHITE, BLUE);
					break;
				}
			...
			switch (i) {
			case 1:
				a.get_str(s, 22, 2, 4, YELLOW);
				break;
			case 2:
				a.get_str(s, 22, 4, 4, YELLOW);
				break;
			case 3:
				break;
			case 4:
